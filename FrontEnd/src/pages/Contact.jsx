  ...
  return (
    <>
      ...
      <div className="text-center mb-12 md:mb-16">
        ...
        <div className="w-24 h-1.5 bg-linear-to-r from-primary via-accent to-primary mx-auto rounded-full mb-6 animate-[scaleIn_0.8s_ease-out_0.2s_both]"></div>
      ...
      <div className="flex flex-col lg:flex-row gap-0 max-w-6xl mx-auto rounded-3xl overflow-hidden shadow-2xl animate-[scaleIn_0.8s_ease-out_0.4s_both]">
        <div className="flex-1 bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-50 p-8 md:p-12 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-linear-to-br from-primary/20 to-accent/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-linear-to-tr from-accent/20 to-primary/20 rounded-full blur-3xl"></div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-6 mb-10">
              {[
                ...
                >
                  <item.icon className={`${item.color} text-2xl min-w-[28px] shrink-0 group-hover:scale-125 transition-transform duration-300`} />
            ...
            <div className="flex gap-4 flex-wrap">
              {[
                ...
                { icon: FaInstagram, color: 'hover:bg-linear-to-r hover:from-purple-600 hover:to-pink-600' },
        ...
        <div className="flex-[1.5] min-h-[350px] lg:min-h-[550px] bg-gray-200 relative overflow-hidden group">
          <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-accent/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          <iframe 
