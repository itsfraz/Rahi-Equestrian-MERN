  ...
  return (
    <>
      ...
      <div className="text-center mb-12 md:mb-16 max-w-4xl mx-auto">
        ...
        <div className="w-24 h-1.5 bg-linear-to-r from-primary via-accent to-primary mx-auto rounded-full mb-8 animate-[scaleIn_0.8s_ease-out_0.2s_both]"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 mt-12">
        {[
          ...
          >
            <div className={`absolute top-0 right-0 w-32 h-32 bg-linear-to-br ${item.gradient} opacity-10 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-700`}></div>
            <div className="relative z-10">
              ...
              <div className={`mt-6 w-16 h-1.5 bg-linear-to-r ${item.gradient} rounded-full transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}></div>
            </div>
          </div>
        ))}
      </div>
